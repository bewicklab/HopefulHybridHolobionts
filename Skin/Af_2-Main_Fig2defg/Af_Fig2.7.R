...
rich_log_line_core<-ggplot() + theme_classic(16) + ylab("Log Core Richness (Skin Genera)") + xlab("Minimum Hosts") +
  scale_x_continuous(breaks = seq(0, 12, by = 2)) + expand_limits(y=4) + #setting x-axis interval and y-axis minimum
...
ggsave("Figure_SI2.7.png", grid_rich, height = 20, width = 20)
