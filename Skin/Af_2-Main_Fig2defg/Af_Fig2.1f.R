...
p_richness<-p_richness+annotate("text", size=6,x=2.5, y=270, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=2.5, y=261, label= paste("p = ",round(kw_richness$p.value,4)))
