...
p_richness<-p_richness+annotate("text", size=6,x=2.7, y=6, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=2.7, y=4, label= paste("p = ",round(kw_richness$p.value,4)))
