...
p_richness<-p_richness+annotate("text", size=6,x=2, y=225, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=2, y=200, label= paste("p = ",round(kw_richness$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_simpson<-p_simpson+annotate("text", size=6,x=2, y=0.75, label= "Kruskal-Wallis")
p_simpson<-p_simpson+annotate("text", size=6,x=2, y=0.69, label= paste("p = ",round(kw_simpson$p.value,6)))
