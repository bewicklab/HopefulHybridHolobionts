...
triangle_bray_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=15,seed=2,dist='bray',ordination='PCoA')
...
write.csv(tests_df,'Table5.11.csv')
