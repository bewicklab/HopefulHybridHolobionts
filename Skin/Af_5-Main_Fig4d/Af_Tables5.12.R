...
triangle_bray_all_20<-TriangleHbootstrap(Z_physeq_SBluG,species_no_SBluG,15,12,dimensions=15,seed=2,dist='bray',ordination='PCoA')
...
write.csv(tests_df,'Table5.6.csv')