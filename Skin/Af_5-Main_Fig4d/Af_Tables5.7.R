...
triangle_bray_all_20<-TriangleHbootstrap(Z_physeq,species_no,15,12,dimensions=20,seed=2,dist='bray',ordination='PCoA')
...
triangle_unifrac_all_2<-TriangleHbootstrap(Z_physeq,species_no,15,12,dimensions=2,seed=1,dist='unifrac',ordination='PCoA')
...
triangle_unifrac_all_20<-TriangleHbootstrap(Z_physeq,species_no,15,12,dimensions=20,seed=2,dist='unifrac',ordination='PCoA')
...
triangle_wunifrac_all_2<-TriangleHbootstrap(Z_physeq,species_no,15,12,dimensions=2,seed=1,dist='wunifrac',ordination='PCoA')
...
triangle_wunifrac_all_20<-TriangleHbootstrap(Z_physeq,species_no,15,12,dimensions=15,seed=2,dist='wunifrac',ordination='PCoA')
...
write.csv(tests_df,'Table5.7.csv')
