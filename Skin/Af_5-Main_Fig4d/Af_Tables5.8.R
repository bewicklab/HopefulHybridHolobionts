...
triangle_euclidean_all_2<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=2,seed=1,ordination='PCoA')
...
triangle_euclidean_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=20,seed=1,ordination='PCoA')
...
triangle_jaccard_all_2<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=2,seed=1,dist='jaccard',ordination='PCoA')
...
triangle_jaccard_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=20,seed=1,dist='jaccard',ordination='PCoA')
...
triangle_bray_all_2<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=2,seed=1,dist='bray',ordination='PCoA')
...
triangle_bray_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=20,seed=2,dist='bray',ordination='PCoA')
...
triangle_unifrac_all_2<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=2,seed=1,dist='unifrac',ordination='PCoA')
...
triangle_unifrac_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=20,seed=2,dist='unifrac',ordination='PCoA')
...
triangle_wunifrac_all_2<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=2,seed=1,dist='wunifrac',ordination='PCoA')
...
triangle_wunifrac_all_20<-TriangleHbootstrap(Z_physeq_SNW,species_no_SNW,15,12,dimensions=15,seed=2,dist='wunifrac',ordination='PCoA')
...
write.csv(tests_df,'Table5.8.csv')