...
#           Plot results, including bootstraps, bootstrap centroid and null plane
    #for Supp. Video 3.4, Main Fig. 3b
...
write.csv(printout,'SkinGenus4H.csv') #Table S3.1 rows 10-12 & Table S3.2 sigma rows 10-12
write.csv(printout2,'SkinGenusnull.csv') #Table S3.2 rows 10-12 I-Inull & p
