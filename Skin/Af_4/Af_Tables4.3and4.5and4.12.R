...
#Test for homogeneity of variances for bray
...
#Test for homogeneity of variances for wunifrac
bd<-betadisper(wunifrac,as.factor(type))
dispersion_anova_wunifrac<-anova(bd)

#Table 5.12 (use adjusted p-values to generate Table 5.3 manually)
