...
rich_line_core <- ggplot() + theme_classic(16) + ylab("Unique Core Richness (Skin ASV)") + xlab("Minimum Hosts") +
...
rich_log_line_core<-ggplot() + theme_classic(16) + ylab("Log Unique Core Richness (Skin ASV)") + xlab("Minimum Hosts") +
  scale_x_continuous(breaks = seq(0, 12, by = 2)) + expand_limits(y=0) + #setting x-axis interval and y-axis minimum
  ...
  geom_line(aes(x=if (length(richness_SBluG_ino[log(richness_SNW_neo)>=0])==12) (kaxis) else head(kaxis,-(12-length(richness_SNW_neo[log(richness_SNW_neo)>=0]))), y=log(richness_SNW_neo[log(richness_SNW_neo)>=0])), colour='lightslateblue') + 
  geom_point(aes(x=if (length(richness_SBluG_ino[log(richness_SNW_neo)>=0])==12) (kaxis) else head(kaxis,-(12-length(richness_SNW_neo[log(richness_SNW_neo)>=0]))), y=log(richness_SNW_neo[log(richness_SNW_neo)>=0])), size=3.5, colour='lightslateblue') +
...
ggsave("Figure_SI2.26.png", grid_rich, height = 20, width = 20)
...
kaxis<-(1:1:sample_size)
faith_line_core <- ggplot() + theme_classic(16) + ylab("Unique Core Faith's PD (Skin ASV)") + xlab("Minimum Hosts") +
  scale_x_continuous(breaks = seq(0, 12, by = 2)) + expand_limits(y=0) + #setting x-axis interval and y-axis minimum
...
faith_log_line_core<-ggplot() + theme_classic(16) + ylab("Log Unique Core Faith's PD (Skin ASV)") + xlab("Minimum Hosts") +
  scale_x_continuous(breaks = seq(0, 12, by = 2)) + expand_limits(y=0) + #setting x-axis interval and y-axis minimum
  geom_line(aes(x=if (length(richness_SBluG_ino[log(richness_SBluG_ino)>=0])==12) (kaxis) else head(kaxis,-(12-length(richness_SBluG_ino[log(richness_SBluG_ino)>=0]))), y=log(richness_SBluG_ino[log(richness_SBluG_ino)>=0])), colour='red') + 
  geom_point(aes(x=if (length(richness_SBluG_ino[log(richness_SBluG_ino)>=0])==12) (kaxis) else head(kaxis,-(12-length(richness_SBluG_ino[log(richness_SBluG_ino)>=0]))), y=log(richness_SBluG_ino[log(richness_SBluG_ino)>=0])), size=3.5, colour='red') +
  geom_line(aes(x=if (length(richness_SBluG_neo[log(richness_SBluG_neo)>=0])==12) (kaxis) else head(kaxis,-(12-length(richness_SBluG_neo[log(richness_SBluG_neo)>=0]))), y=log(richness_SBluG_neo[log(richness_SBluG_neo)>=0])), colour='magenta') + 
...
ggsave("Figure_SI2.27.png", grid_faith, height = 20, width = 20)