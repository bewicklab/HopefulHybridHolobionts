...
p_richness<-p_richness+annotate("text", size=6,x=3, y=9, label= "Kruskal-Wallis")
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_faith<-p_faith+annotate("text", size=6,x=3.2, y=20, label= "Kruskal-Wallis")
p_faith<-p_faith+annotate("text", size=6,x=3.2, y=19, label= paste("p = ",round(kw_faith$p.value,4)))
...
#Make your plot
p_faith #SI Fig. 2.8e & Main Fig. 2f
