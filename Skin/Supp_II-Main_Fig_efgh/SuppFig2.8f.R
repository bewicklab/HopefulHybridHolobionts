...
p_richness<-p_richness+annotate("text", size=6,x=3, y=35, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=3, y=33.5, label= paste("p = ",round(kw_richness$p.value,4)))
