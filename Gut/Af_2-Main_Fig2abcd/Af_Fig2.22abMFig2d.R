...
p_richness<-p_richness+annotate("text", size=6,x=3, y=15, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=3, y=8, label= paste("p = ",round(kw_richness$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_faith<-p_faith+annotate("text", size=6,x=2.5, y=25, label= "Kruskal-Wallis")
...
#Make your plot
p_faith #SI Fig. 2.22a & Main Fig. 2d
