...
anosim_pvalues<-c(anosim_by_group_euclidean$signif,anosim_by_group_jaccard$signif,anosim_by_group_bray$signif,anosim_by_group_unifrac$signif,anosim_by_group_wunifrac$signif)
