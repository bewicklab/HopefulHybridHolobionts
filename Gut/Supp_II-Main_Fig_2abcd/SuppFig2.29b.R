...
#Find the taxa unique to SBluG_ino and pull out abundances on either hybrid array
...
#Find the taxa unique to SNW_marm and pull out abundances on either hybrid array and SBluG_ino
...
#Find the taxa unique to SNW_marm and SBluG_ino and pull out abundances on either hybrid array
...
write.csv(sharing,'Genus_gut_Venn.csv') #Fig. 2.29b
