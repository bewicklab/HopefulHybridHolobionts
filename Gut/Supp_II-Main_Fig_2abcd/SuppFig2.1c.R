...
p_richness<-p_richness+annotate("text", size=6,x=3, y=48, label= "Kruskal-Wallis")
p_richness<-p_richness+annotate("text", size=6,x=3, y=41, label= paste("p = ",round(kw_richness$p.value,4)))
