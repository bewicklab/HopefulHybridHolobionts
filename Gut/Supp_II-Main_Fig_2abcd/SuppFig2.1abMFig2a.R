...
p_richness<-p_richness+annotate("text", size=6,x=3, y=7, label= "Kruskal-Wallis")
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_faith<-p_faith+annotate("text", size=6,x=2.9, y=1.5, label= "Kruskal-Wallis")
...
#Make your plot
p_faith #SI Fig. 2.1b & Main Fig. 2a
