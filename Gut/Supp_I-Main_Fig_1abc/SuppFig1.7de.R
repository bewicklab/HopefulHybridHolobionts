...
p_jaccard_overall<-p_jaccard_overall+annotate("text", size=6,x=1.1, y=0.91, label= "Kruskal-Wallis")
p_jaccard_overall<-p_jaccard_overall+annotate("text", size=6,x=1.1, y=0.906, label= paste("p = ",round(kw_jaccard_overall$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_bray_overall<-p_bray_overall+annotate("text", size=6,x=2.5, y=0.87, label= "Kruskal-Wallis")
p_bray_overall<-p_bray_overall+annotate("text", size=6,x=2.5, y=0.864, label= paste("p = ",round(kw_bray_overall$p.value,4)))
