...
p_jaccard_overall<-p_jaccard_overall+annotate("text", size=6,x=3.5, y=0.977, label= "Kruskal-Wallis")
p_jaccard_overall<-p_jaccard_overall+annotate("text", size=6,x=3.5, y=0.978, label= paste("p = ",round(kw_jaccard_overall$p.value,4)))
...
#Make your plot
p_jaccard_overall    #SI Fig. 1.7a

median(diversity_df$jaccard_overall[which(diversity_df$type=='SBluG_ino')])
median(diversity_df$jaccard_overall[which(diversity_df$type=='SBluG_neo')])
median(diversity_df$jaccard_overall[which(diversity_df$type=='SNW_neo')])
median(diversity_df$jaccard_overall[which(diversity_df$type=='SNW_marm')])
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
#p_jaccard_overall_phy<-p_jaccard_overall_phy+annotate("text", size=6,x=1.2, y=0.9, label= "Kruskal-Wallis")
#p_jaccard_overall_phy<-p_jaccard_overall_phy+annotate("text", size=6,x=1.2, y=0.897, label= paste("p = ",round(kw_jaccard_overall_phy$p.value,4)))
...
#Make your plot
p_jaccard_overall_phy #SI Fig. 1.7c & Main Fig. 1b

median(diversity_df$jaccard_overall_phy[which(diversity_df$type=='SBluG_ino')])
median(diversity_df$jaccard_overall_phy[which(diversity_df$type=='SBluG_neo')])
median(diversity_df$jaccard_overall_phy[which(diversity_df$type=='SNW_neo')])
median(diversity_df$jaccard_overall_phy[which(diversity_df$type=='SNW_marm')])
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_bray_overall<-p_bray_overall+annotate("text", size=6,x=2.5, y=0.94, label= "Kruskal-Wallis")
p_bray_overall<-p_bray_overall+annotate("text", size=6,x=2.5, y=0.934, label= paste("p = ",round(kw_bray_overall$p.value,4)))
...
#Make your plot
p_bray_overall  #SI Fig. 1.7b

median(diversity_df$bray_overall[which(diversity_df$type=='SBluG_ino')])
median(diversity_df$bray_overall[which(diversity_df$type=='SBluG_neo')])
median(diversity_df$bray_overall[which(diversity_df$type=='SNW_neo')])
median(diversity_df$bray_overall[which(diversity_df$type=='SNW_marm')])
