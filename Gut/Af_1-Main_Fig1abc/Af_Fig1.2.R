...
p_richness<-p_richness+annotate("text", size=6,x=1, y=680, label= paste("p = ",round(mw_richness$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_shannon<-p_shannon+annotate("text", size=6,x=1.4, y=0.8, label= "Mann-Whitney U")
p_shannon<-p_shannon+annotate("text", size=6,x=1.4, y=0.4, label= paste("p = ",round(mw_shannon$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_simpson<-p_simpson+annotate("text", size=6,x=1.5, y=0.6, label= "Mann-Whitney U")
p_simpson<-p_simpson+annotate("text", size=6,x=1.5, y=0.55, label= paste("p = ",round(mw_simpson$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_faiths<-p_faiths+annotate("text", size=6,x=2, y=60, label= "Mann-Whitney U")
p_faiths<-p_faiths+annotate("text", size=6,x=2, y=55, label= paste("p = ",round(mw_faiths$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_raos<-p_raos+annotate("text", size=6,x=1.5, y=0.15, label= "Mann-Whitney U")
p_raos<-p_raos+annotate("text", size=6,x=1.5, y=0.12, label= paste("p = ",round(mw_raos$p.value,4)))
