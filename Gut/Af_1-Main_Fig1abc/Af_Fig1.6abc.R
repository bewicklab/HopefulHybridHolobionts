...
p_richness<-p_richness+annotate("text", size=6,x=2, y=205, label= "Mann-Whitney U")
p_richness<-p_richness+annotate("text", size=6,x=2, y=195, label= paste("p = ",round(mw_richness$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_shannon<-p_shannon+annotate("text", size=6,x=2, y=5.4, label= "Mann-Whitney U")
p_shannon<-p_shannon+annotate("text", size=6,x=2, y=5.1, label= paste("p = ",round(mw_shannon$p.value,4)))
...
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_simpson<-p_simpson+annotate("text", size=6,x=1.5, y=0.3, label= "Mann-Whitney U")
p_simpson<-p_simpson+annotate("text", size=6,x=1.5, y=0.25, label= paste("p = ",round(mw_simpson$p.value,4)))
